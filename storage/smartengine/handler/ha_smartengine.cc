                           ...
                           dd::Table *dd_table)
{
  ...
  */
  ...
  /*
    SQL-layer 8.0.46 DDL compat already stripped FOREIGN KEY from the
    parsed table definition before create(). The original query string
    still contains the clause, so do not scan thd->query() here.
  */
